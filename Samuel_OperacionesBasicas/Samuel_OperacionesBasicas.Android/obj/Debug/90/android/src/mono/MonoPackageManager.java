...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Samuel_OperacionesBasicas.Android.dll" comes first in this list. */
		"Samuel_OperacionesBasicas.Android.dll",
		"FormsViewGroup.dll",
		"Samuel_OperacionesBasicas.dll",
